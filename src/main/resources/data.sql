...
insert into link (short_link_id, original_url, created_at, updated_at, valid_from, valid_until, description, marked_for_deletion, is_latest)
...
insert into Link_User (link_id, user_name)
